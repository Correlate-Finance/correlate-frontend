            ...
            <div className='text-white border-white'>
                <Table>
                    ...
                    <TableBody>
                        {data.map((dp) => (
                            <TableRow key={dp[0]}>
                                <TableCell className="font-medium w-min whitespace-nowrap">{dp[0]}</TableCell>
                                <TableCell className="whitespace-nowrap">{USDollar.format(Number(dp[1].replace(",", "")))}</TableCell>
                            </TableRow>
                        ))}
                    </TableBody>
                </Table>
