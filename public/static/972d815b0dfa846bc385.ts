...
Office.onReady(function (info) {
  document.getElementById("ok-button").onclick = function () {
    return tryCatch2(sendStringToParentPage);
  };
});
      ...
      switch (_a.label) {
        ...
        case 1:
          ...
          if (token === undefined || token === null || token === "Invalid credentials") {
            ...
            email = document.getElementById("error");
...
function login() {
  return __awaiter(this, void 0, void 0, function () {
    var url, email, password, token;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          url = "https://api.correlatefinance.com/users/login";
